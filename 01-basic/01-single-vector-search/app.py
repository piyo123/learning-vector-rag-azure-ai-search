...
INDEX_NAME = "kazuma-rag-index1" # The index was created via the Azure portal (refer to kazuma-rag-index1-initial.json).
...
def search(query: str, k_nearest_neighbors: int = 50) -> list[str]:
    ...
    results = search_client.search(
        search_text=None, # Specify search keywords for hybrid (keyword + vector) search
